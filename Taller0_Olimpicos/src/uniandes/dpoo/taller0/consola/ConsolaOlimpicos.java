...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el nombre del país al cual representa el atleta");
	...
	/**
	 * Ejecuta la opción para consultar el país al cual representa el atleta.
	 */
	
	private void ejecutarPaisPorAtleta()
	{
		System.out.println("\n" + "País al cual representa un atleta" + "\n");

		String atleta = input("Por favor ingrese el nombre del atleta");
		Pais paises = calculadora.paisPorAtleta(atleta);
		
		if (paises == null)
		{
			System.out.println("No se encontró un atleta llamado " + "'" + atleta + "'");
		}
		
		else
		{
			System.out.println("El país al cual representa el atleta " +  "'" + atleta + "'" + " es: " + paises.darNombre());
		}
	}
